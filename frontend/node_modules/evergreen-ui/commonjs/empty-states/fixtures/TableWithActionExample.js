    ...
    return (react_1.default.createElement(layers_1.Pane, { marginBottom: (0, scales_1.majorScale)(8) },
        react_1.default.createElement(table_1.Table, { maxWidth: 1152, width: "100%" },
            ...
            react_1.default.createElement(table_1.Table.Body, { height: "auto" },
                react_1.default.createElement(EmptyState_1.default, { background: "light", title: "No audiences found", orientation: "horizontal", icon: react_1.default.createElement(icons_1.SearchIcon, { color: colors.gray500 }), iconBgColor: colors.gray200, description: "Click the button below to create a new Audience. Once done, you will see it come up in this list.", primaryCta: react_1.default.createElement(EmptyState_1.default.PrimaryButton, null, "Create Audience") })))));
};
exports.default = TableWithActionExample;
