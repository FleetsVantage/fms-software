...
const TextareaField = (0, react_1.memo)((0, react_1.forwardRef)(function TextareaField(props, ref) {
    const id = (0, hooks_1.useId)('TextareaField', props.id);
    const { 
    ...
    inputWidth = '100%', isInvalid, label, placeholder, required, resize, spellCheck, validationMessage } = props, 
    // Rest props are spread on the FormField
    rest = __rest(props
    /**
     * Split the wrapper props from the input props.
     */
    , ["appearance", "description", "disabled", "hint", "id", "inputHeight", "inputWidth", "isInvalid", "label", "placeholder", "required", "resize", "spellCheck", "validationMessage"]);
    /**
     * Split the wrapper props from the input props.
     */
    ...
    return (react_1.default.createElement(form_field_1.FormField, Object.assign({ marginBottom: 24, label: label, isRequired: required, hint: hint, description: description, validationMessage: validationMessage, labelFor: id }, matchedProps),
        react_1.default.createElement(Textarea_1.default, Object.assign({ id: id, ref: ref, width: inputWidth, height: inputHeight, disabled: disabled, required: required, isInvalid: isInvalid, appearance: appearance, placeholder: placeholder, spellCheck: spellCheck, resize: resize, "aria-describedby": (0, generate_aria_describedby_1.generateAriaDescribedBy)(id, { description, hint, validationMessage }) }, remainingProps))));
}));
TextareaField.propTypes = Object.assign(Object.assign(Object.assign({}, Textarea_1.default.propTypes), form_field_1.FormField.propTypes), { 
    /**
